 ...
 * @author Surabhi
 */
public class viflty extends HttpServlet {
        ...
        try  {
            ...
            //faculties view page starts here
                            out.println("<p class=\"heading1\">VIEW ACCOUNTANT</p>");
                                ...
                                ResultSet rs=stmt.executeQuery("select * from accountant where email like '%faculties%' order by aid ");
                                    ...
                                    while(rs.next())
                                    {
                                        ...
                                        String ASUBHD=rs.getString("subject_handling");
                                        out.println("<tr><td>"+AID2+"</td><td>"+ANAME2+"</td><td>"+APASS2+"</td><td>"+ADDR2+"</td><td>"+APHONE2+"</td><td>"+AMAIL2+"</td><td>"+ASUBHD+"</td><td><a href=delflty?id="+AID2+"><font color=\"red\">delete</font></a>     <a href=updflty?id="+AID2+"><font color=\"brown\">update</font></a></td></tr>");
                                    }
                                    out.println("</table>");
                                con.close();
            out.println("</body>");
