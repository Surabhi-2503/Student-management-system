 ...
 * @author Surabhi
 */
public class passupdatedb1 extends HttpServlet {
            ...
            Class.forName("oracle.jdbc.driver.OracleDriver");
                ...
                con.close();
                           out.println("<script>alert(\"password successfully changed\")</script>");
                            out.println("<meta http-equiv='refresh' content='0;URL=vipf2'>");
            out.println("</body>");
            out.println("</html>");
            }else{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(passupdatedb1.class.getName()).log(Level.SEVERE, null, ex);
