 ...
 * @author Surabhi
 */
public class addfee1_details extends HttpServlet {
       ...
       out.println("box-shadow: inset 1px -1px black;");
         ...
         out.println(" }");       
           ...
           out.println("<ul>");
                    ...
                    out.println("<h2><font color=\"black\">FEE-MANAGEMENT</font></h2>");
                    out.println("<br><br>USN:<br><input type=\"text\" name=\"fusn1\" value="+Fusn+" required> ");
                    out.println("<br><br>TOTAL_AMOUNT:<br><input type=\"number\" name=\"tfee\" value=\"80000\" required> ");
                    out.println("<br><br>AMOUNT_PAID:<br><input type=\"number\" name=\"fpaid\" placeholder=\"enter the amount paid\" required>");
                    out.println("<br><br><input type=\"submit\" value=\"CHECK\"><br>");
                    out.println("</form>");
                    out.println("</div>");
                        String FUSN=request.getParameter("fusn1");
                        String FTTL=request.getParameter("tfee");
                        String FPAID=request.getParameter("fpaid");
                        if(!FUSN.equals(null)&&!FUSN.equals("")){ 
                            s.setAttribute("FUSN1",FUSN);
                            s.setAttribute("FTTL1",FTTL);
                             s.setAttribute("FPAID1",FPAID);
                            response.sendRedirect("feedb");
