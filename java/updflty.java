 ...
 * @author Surabhi
 */
public class updflty extends HttpServlet {
                ...
                if(!AID2.equals(null)&&!AID2.equals("")) 
                    ...
                    while(rs.next()){
                        ...
                        out.println("<form method=\"post\">");
                            ...
                            out.println("SUBJECT_HANDLING:<br><input type=\"text\" name=\"subhan1\" value="+subhan+" required><br>");
                        ...
                        String ASUBHAN=request.getParameter("subhan1");
                       if(APASWD.equals(ACFMPSWD))
                       {
                            if(APHONE.length()==10)
                            {
                                ...
                                s.setAttribute("ASUBHAND",ASUBHAN);
                                response.sendRedirect("updadb2");
                            }
                             else
                            {
