	...
	out.println("height: 50%;");
         ...
         out.println(" }");       
          ...
          out.println("<ul>");
            ...
            out.println("<p class=\"heading1\">ADD ACCOUNTANT</p>");
            out.println("<div class=\"aa\">");
            out.println("<form method=\"get\">");
           // out.println("ACC ID:<br><input type=\"number\" name=\"AID\"  placeholder=\"123\" required><br>");
            out.println("NAME:<br><input type =\"text\" name=\"Aname\" placeholder=\"Enter the name\" required><br>");
            ...
            out.println("USERID:<br><input type =\"text\" name=\"mailid\" placeholder=\"eg:xyz123\" required>@accountants.com<br>");
            out.println("<br>SUBJECT_HANDLING:<br><input type=\"text\" name=\"subhan\" value=\"non_Teaching\"><br>");
