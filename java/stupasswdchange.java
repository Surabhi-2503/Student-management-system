 ...
 * @author Surabhi
 */
public class stupasswdchange extends HttpServlet {
  ...
  out.println("<p class=\"heading1\">password change</p>");
            ...
            out.println("<br>USN:<br><input type =\"text\" name=\"STUSN\" placeholder=\"Enter the usn\" size=\"40\" required><br>");
           ...
           //  String ACCID=request.getParameter("AID");
            String SUUSN=request.getParameter("STUSN");
            String SOPASS=request.getParameter("Apass");
          
            if(!SOPASS.equals("")&&!SOPASS.equals(null))
            {
                
                    HttpSession s=request.getSession();
                  //  s.setAttribute("AID", ACCID);
                    s.setAttribute("NAME",SUUSN);
                    s.setAttribute("PSWD",SOPASS);
                    response.sendRedirect("stupasswdchange1");
