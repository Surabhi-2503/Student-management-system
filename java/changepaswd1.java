 ...
 * @author Surabhi
 */
public class changepaswd1 extends HttpServlet {
         ...
         out.println(" }");       
            ...
            out.println("<ul>");
                    ...
                    out.println("<div class=\"dropdown-content\">");
                            out.println("  <a href=\"attendance\">ATTENDANCE MANAGEMENT</a>");
                            out.println(" <a href=\"iamarks\">INTERNALS MARKS UPDATING</a>");
            ...
            out.println("<p class=\"heading1\">PASSWORD CHANGE</p>");
            out.println("<div class=\"aa\">");
            out.println("<form method=\"get\">");
            out.println("<br>NAME:<br><input type =\"text\" name=\"Aname\" placeholder=\"Enter the name without giving space\" size=\"40\" required><br>");
            out.println("<br>OLD_PASSWORD:<br><input type=\"password\" name=\"Apass\" placeholder=\"eg:123qws\" required><br>");
            out.println("<br>USERID:<br><input type =\"email\" name=\"mailid\" placeholder=\"eg:xyz123\" required><br>");
           ...
           //  String ACCID=request.getParameter("AID");
            ...
            if(!APASWD.equals("")&&!APASWD.equals(null))
            {
                  ...
                  //  s.setAttribute("AID", ACCID);
                    ...
                    response.sendRedirect("passwdchange1");
